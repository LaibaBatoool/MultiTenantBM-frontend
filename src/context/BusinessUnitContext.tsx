...
export function BusinessUnitProvider({ children }: { children: ReactNode }) {
    ...
    const isSuperadmin = currentUser ? currentUser.businessUnitId === null : true;
    ...
    return (
        <BusinessUnitContext.Provider
            value={{ selectedBusinessUnit, selectBusinessUnit, clearSelectedBusinessUnit, isSuperadmin, isReady }}
        >
            {children}
        </BusinessUnitContext.Provider>
    );
